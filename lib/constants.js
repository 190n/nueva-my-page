const constants = {
    ...
    INVADER_FONTS: 'Courier, "Liberation Mono", Cousine, monospace',
...
constants.SHIELD_WIDTH = constants.SHIELD_PATTERN.join('').split('\n')[0].length * constants.SHIELD_PART_SIZE;
constants.SHIELD_HEIGHT = constants.SHIELD_PATTERN.join('').split('\n').length * constants.SHIELD_PART_SIZE;
